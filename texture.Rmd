...
2. Weigh 40 grams (+/- 0.5) of air dry <2mm soil into a bottle. Add 50 mL sodium hexametaphosphate and 100 mL water to that bottle. Shake on a mechanical shaker overnight.  
...
colnames(settlingtime)<-c("Sand (minutes)", "Clay (minutes)")
...
```{r}
#example calculation from some of my data
